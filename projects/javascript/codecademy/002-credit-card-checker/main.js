...
// Finds all invalid credit card numbers from a batch.
const findInvalidCards = (arr) => {
  return arr.filter(card => !validateCred(card));
};

// Identifies credit card companies that issued invalid cards.
...
console.log("Companies that issued invalid cards:", invalidCardCompanies);
